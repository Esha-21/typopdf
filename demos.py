...
if __name__ == '__main__':
    ...
    # usage demo
    text = """
    Thank you ! Archana maam for guidance .
"""
    ...
    # lines = lyrics.greeting.split("\n")
    # biases = [0.75 for i in lines]
    # styles = [12 for i in lines]
    #  .75 , 12

    # hand.write(
    #     filename='img/report.svg',
    #     lines=lines,
    #     biases=biases,
    #     styles=styles,
    # )
...
# --------------------------------------------------
# DEMO MODE (RUN DIRECTLY)
# --------------------------------------------------
if __name__ == "__main__":

    # text = """
    # Hello Professor,
    # This handwritten paragraph is generated using an
    # AI-based text to handwriting synthesis system.
    # The model learns pen stroke movements from
    # real human handwriting data.
    # """
    ...
    #     text=text,
    #     output_path="img/finaloutput.svg",
    #     bias=0.75,
    #     style=12
    # )

    print("Handwriting saved as img/finaloutput.svg")
